...
<div id="comments" class="comments-area">
	<?php if ( have_comments() ) : ?>
					...
					<div class="single-comment__author">
						...
						<div class="single-comment__author__meta" >
							...
							<a href="<?php echo esc_url( get_comment_link() ); ?>" class="single-comment__author__meta__timestamp">
								<?php
								/* translators: %1$s: date of comment, %2$s: time of comment. */
								printf( esc_html__( '%1$s at %2$s', 'smartdroid' ), esc_html( get_comment_date() ), esc_html( get_comment_time() ) );
								?>
							</a>
						</div>
					</div>
		...
		<?php if ( ! comments_open() && get_comments_number() ) : ?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'smartdroid' ); ?></p>
		<?php endif; ?>
